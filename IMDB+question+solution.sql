...
SELECT 'DIRECTOR_MAPPING' AS TableName, COUNT(*) AS Count FROM DIRECTOR_MAPPING
UNION ALL
SELECT 'GENRE' AS TableName, COUNT(*) AS Count FROM GENRE
UNION ALL
SELECT 'MOVIE' AS TableName, COUNT(*) AS Count FROM MOVIE
UNION ALL
SELECT 'NAMES' AS TableName, COUNT(*) AS Count FROM NAMES
UNION ALL
SELECT 'RATINGS' AS TableName, COUNT(*) AS Count FROM RATINGS
UNION ALL
SELECT 'ROLE_MAPPING' AS TableName, COUNT(*) AS Count FROM ROLE_MAPPING;
...
SELECT
    ...
    COUNT(movie_id) AS movie_count,
    ROUND(SUM(w_avg) / SUM(total_votes), 2) AS actress_avg_rating,
    DENSE_RANK() OVER (ORDER BY SUM(w_avg) / SUM(total_votes) DESC) AS actress_rank
FROM (
    SELECT
...
SELECT * FROM actress_summary LIMIT 3;
